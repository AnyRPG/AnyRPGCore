    ...
    */
    ...
    public static List<Quest> GetQuestListByType(string questStatusType, QuestNode[] questNodeArray, bool requireInQuestLog = false, bool requireStartQuest = false, bool requireEndQuest = false) {
        ...
        foreach (QuestNode questNode in questNodeArray) {
            if (SystemQuestManager.MyInstance.GetResource(questNode.MyQuest.MyName).GetStatus() == questStatusType && (requireInQuestLog == true ? QuestLog.MyInstance.HasQuest(questNode.MyQuest.MyName) : true) && (requireStartQuest == true ? questNode.MyStartQuest : true) && (requireEndQuest == true ? questNode.MyEndQuest : true)) {
