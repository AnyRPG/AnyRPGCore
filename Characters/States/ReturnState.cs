...
namespace AnyRPG {
    public class ReturnState : IState {
        ...
        public void Update() {
            ...
            float distanceToLeashPosition = Vector3.Distance(baseController.LeashPosition, baseController.BaseCharacter.CharacterUnit.transform.position);
            ...
            if (distanceToLeashPosition <= 1) {
                ...
                float agentDestinationDrift = Vector3.Distance(baseController.LeashPosition, baseController.BaseCharacter.UnitController.NavMeshAgent.destination);
                if (agentDestinationDrift >= baseController.BaseCharacter.UnitController.NavMeshAgent.stoppingDistance + baseController.BaseCharacter.UnitController.UnitMotor.MyNavMeshDistancePadding) {
