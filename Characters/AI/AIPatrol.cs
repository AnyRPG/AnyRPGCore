...
public class AIPatrol : MonoBehaviour {
    ...
    public Vector3 GetRandomDestination() {
        ...
        if (destinationList.Count > 0) {
            ...
            //Debug.Log(gameObject.name + ".AIPatrol.GetRandomDestination(): randomnumber: " + randomNumber + "; location: " + destinationList[randomNumber]);
            ...
            if (characterUnit.MyCharacter == null) {
                Debug.Log("AIPatrol.GetRandomDestination(): CharacterUnit.MyCharacter is null!");
            }
            if (characterUnit.MyCharacter.MyCharacterController == null) {
                Debug.Log("AIPatrol.GetRandomDestination(): CharacterUnit.MyCharacter.MyCharacterController is null!");
            }
