...
namespace AnyRPG {
    ...
    public class PetPreviewCameraController : MonoBehaviour {
        // public variables
        ...
        private void JumpToWantedPosition() {
            ...
            CameraManager.MyInstance.MyPetPreviewCamera.transform.position = wantedPosition;
        }

        private void SmoothToWantedPosition() {
            //Debug.Log("SmoothToWantedPosition(" + wantedPosition + ")");
            CameraManager.MyInstance.MyPetPreviewCamera.transform.position = Vector3.MoveTowards(CameraManager.MyInstance.MyPetPreviewCamera.transform.position, wantedPosition, cameraSpeed);
        }

        private void LookAtTargetPosition() {
            //Debug.Log("AnyRPGCameraController.LookAtTargetPosition()");
            CameraManager.MyInstance.MyPetPreviewCamera.transform.LookAt(targetPosition);
        }
