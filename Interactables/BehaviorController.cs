    ...
    public class BehaviorController {
        ...
        public void AddUnitProfileSettings() {
            if (unitController != null && unitController.BaseCharacter != null && unitController.BaseCharacter.UnitProfile != null) {
                if (unitController.BaseCharacter.UnitProfile.BehaviorNames != null) {
                    foreach (string behaviorName in unitController.BaseCharacter.UnitProfile.BehaviorNames) {
                        BehaviorProfile tmpBehaviorProfile = null;
                        if (unitController.BaseCharacter.UnitProfile.UseBehaviorCopy == true) {
