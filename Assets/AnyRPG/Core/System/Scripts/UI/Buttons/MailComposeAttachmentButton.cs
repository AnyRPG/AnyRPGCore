...
namespace AnyRPG {
    public class MailComposeAttachmentButton : HighlightButton, IDescribable {
        ...
        [FormerlySerializedAs("tradeBackGroundImage")]
        [SerializeField]
        ...
        private MailComposePanel mailComposePanel = null;
        ...
        public void SetMailComposePanel(MailComposePanel mailComposePanel) {
            this.mailComposePanel = mailComposePanel;
        }
        ...
        private void UpdateVisual() {
            if (items.Count == 0) {
                ...
                title.text = string.Format("<color=#00FFFF>Empty Attachment Slot</color>\nDrop item here");
        ...
        public string GetSummary() {
            ...
            // cyan
            return string.Format("<color=#00FFFF>Empty Attachment Slot</color>\nDrop Item here");
        }
