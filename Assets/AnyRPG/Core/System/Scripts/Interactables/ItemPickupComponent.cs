namespace AnyRPG {
    public class ItemPickupComponent : LootableNodeComponent {
        ...
        public ItemPickupComponent(InteractableBase interactable, ItemPickupProps interactableOptionProps, SystemGameManager systemGameManager) : base(interactable, interactableOptionProps, systemGameManager) {
        }
