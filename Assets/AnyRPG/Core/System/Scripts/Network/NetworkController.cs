...
namespace AnyRPG {
    ...
    public abstract class NetworkController : ConfiguredMonoBehaviour {
        ...
        public abstract void InteractWithOption(UnitController sourceUnitController, InteractableBase targetInteractable, int componentIndex, int choiceIndex);
        public abstract void RequestSetPlayerCharacterClass(InteractableBase interactable, int componentIndex);
        public abstract void SetPlayerCharacterSpecialization(InteractableBase interactable, int componentIndex);
        public abstract void RequestSetPlayerFaction(InteractableBase interactable, int componentIndex);
        public abstract void RequestLearnSkill(InteractableBase interactable, int componentIndex, int skillId);
        public abstract void RequestSendMail(InteractableBase interactable, int componentIndex, MailMessageRequest sendMailRequest);
        public abstract void RequestAcceptQuest(InteractableBase interactable, int componentIndex, Quest quest);
        public abstract void RequestCompleteQuest(InteractableBase interactable, int componentIndex, Quest quest, QuestRewardChoices questRewardChoices);
        public abstract void SellVendorItem(InteractableBase interactable, int componentIndex, long itemInstanceId);
        public abstract void BuyItemFromVendor(InteractableBase interactable, int componentIndex, int collectionIndex, int itemIndex, string resourceName);
        public abstract void RequestSpawnUnit(InteractableBase interactable, int componentIndex, int unitLevel, int extraLevels, bool useDynamicLevel, string unitProfileName, string unitToughnessName);
        public abstract void RequestTurnInDialog(InteractableBase interactable, int componentIndex, Dialog dialog);
        ...
        public abstract void RequestUpdatePlayerAppearance(InteractableBase interactable, int componentIndex, string unitProfileName, string appearanceString, List<SwappableMeshSaveData> swappableMeshSaveData);
        public abstract void RequestChangePlayerName(InteractableBase interactable, int componentIndex, string newName);
        ...
        public abstract void RequestListAuctionItems(InteractableBase interactable, int componentIndex, ListAuctionItemRequest listAuctionItemRequest);
        public abstract void RequestCancelAuction(int auctionItemId);
        public abstract void RequestBuyAuctionItem(int auctionItemId);
        public abstract void RequestSearchAuctions(InteractableBase interactable, int componentIndex, string searchText, bool onlyShowOwnAuctions);
        ...
        public abstract void RequestCreateGuild(InteractableBase interactable, int componentIndex, string guildName);
        public abstract void CheckGuildName(InteractableBase interactable, int componentIndex, string guildName);
        ...
        public abstract void AdvertiseAddToBuyBackCollection(UnitController sourceUnitController, int accountId, InteractableBase interactable, int componentIndex, InstantiatedItem newInstantiatedItem);
        ...
        public abstract void AdvertiseOpenInteractionWindow(int accountId, InteractableBase targetInteractable);
        public abstract void RequestInteractWithInteractable(InteractableBase target);
