...
namespace AnyRPG {
    ...
    public interface INetworkConnector {
        ...
        public void SellVendorItem(InteractableBase interactable, int componentIndex, long itemInstanceId);
        ...
        public void AdvertiseSellItemToPlayer(UnitController sourceUnitController, InteractableBase interactable, int componentIndex, int collectionIndex, int itemIndex, string resourceName, int quantity);
