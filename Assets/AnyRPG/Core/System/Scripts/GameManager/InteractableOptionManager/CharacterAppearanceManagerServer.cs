...
namespace AnyRPG {
    public class CharacterAppearanceManagerServer : InteractableOptionManager {
        ...
        public void UpdatePlayerAppearance(UnitController sourceUnitController, int accountId, InteractableBase interactable, int componentIndex, string unitProfileName, string appearanceString, List<SwappableMeshSaveData> swappableMeshSaveData) {
