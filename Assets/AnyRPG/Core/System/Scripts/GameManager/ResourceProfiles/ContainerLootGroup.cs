...
namespace AnyRPG {
    ...
    [System.Serializable]
    public class ContainerLootGroup {
        ...
        [Tooltip("The amount of items that can drop from this list.  0 is unlimited only in random rolls.  In weighted rolls, this number must be 1 or greater, and will be set to 1 if 0 is entered.")]
        [SerializeField]
        ...
        [SerializeField]
        private List<ContainerLoot> loot = new List<ContainerLoot>();

        public List<ContainerLoot> Loot { get => loot; set => loot = value; }
