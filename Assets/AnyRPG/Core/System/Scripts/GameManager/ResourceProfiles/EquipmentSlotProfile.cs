            ...
            if (equipmentSlotTypeList != null) {
                foreach (string equipmentSlotTypeName in equipmentSlotTypeList) {
                    ...
                    if (tmpSlotType != null) {
                        ...
                        Debug.LogError("SystemAbilityManager.SetupScriptableObjects(): Could not find equipmentSlotType: " + equipmentSlotTypeName + " while inititalizing " + ResourceName + ".  CHECK INSPECTOR");
                    }
                }
            }
