...
namespace AnyRPG {
    ...
    public class AnyRPGStateMachine : MonoBehaviour {
        ...
        public class State {
            public Action DoStateUpdate = DoNothing;
        ...
        void ConfigureCurrentState() {
            ...
            state.DoStateUpdate = ConfigureDelegate<Action>("StateUpdate", DoNothing);
        ...
        /// <summary>
        /// Message callback from the AnyRPGCharacterController that runs the state specific update between global updates
        /// </summary>
        void StateUpdate() {
        ...
        protected virtual void EarlyGlobalStateUpdate() { }

        protected virtual void LateGlobalStateUpdate() { }
