...
public class MissingReferencesFinder : MonoBehaviour {
    ...
    [MenuItem("Tools/AnyRPG/Find Missing References/In current scene", false, 50)]
    ...
    [MenuItem("Tools/AnyRPG/Find Missing References/In current prefab", true, 51)]
    public static bool FindMissingReferencesInCurrentPrefabValidate() => PrefabStageUtility.GetCurrentPrefabStage() != null;

    [MenuItem("Tools/AnyRPG/Find Missing References/In all scenes in build", false, 52)]
    ...
    [MenuItem("Tools/AnyRPG/Find Missing References/In assets", false, 52)]
    ...
    [MenuItem("Tools/AnyRPG/Find Missing References/Everywhere", false, 53)]
